...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    featuredData = await axios.get(
      `https://api.themoviedb.org/3/discover/${context.query.mediaType}?primary_release_year=2022&with_genres=${context.query.genre_id}&api_key=174406b9a949ae4ad6a40666c6a29393&language=en-US`
    );
